...
const Modal: React.FC<ModalProps> = ({ setIsModalOpen }) => {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm("service_4odk25g", "template_4uw9b91", form.current, {
        publicKey: "QkgIDg8bNUVX8WYq-",
      })
      .then(
        () => {
          console.log("SUCCESS!");
      ...
      <div className="modal_wrapper fixed inset-0 z-100 h-full  bg-black/60">
        <div>
          ...
          <div className="absolute inset-0 overflow-y-auto">
            <div className=" my-10 mx-auto wrapper p-6 md:p-14 border border-border rounded-2xl bg-primary-bg max-w-[90%] lg:max-w-3xl">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div>
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-xs text-lg text-primary-text hover:cursor-pointer hover:text-secondary-text hover:font-medium duration-200 hover:bg-secondary-bg "
                    >
                      &#10005;
                    </button>
                  </div>
